...
func main() {
	...
	for {
		...
		fmt.Println("=====================================================================")
		fmt.Println(" 1) PQPG Custom Crypto Engine   [Multi-Platform]")
		fmt.Println(" 2) OQS Extension Crypto Engine [Linux Only]")
		fmt.Println(" 3) Proton OpenPGP PQC Engine   [Multi-Platform / Interoperable]")
		fmt.Println("\n 99) Exit")
		fmt.Println("=====================================================================")
