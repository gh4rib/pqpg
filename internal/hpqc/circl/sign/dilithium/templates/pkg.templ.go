...
{{- if .NIST }}
	"github.com/gh4rib/pqpg/internal/hpqc/circl/sign/mldsa/{{.Pkg}}/internal"
{{- else }}
	"github.com/gh4rib/pqpg/internal/hpqc/circl/sign/dilithium/{{.Pkg}}/internal"
{{- end }}
	common "github.com/gh4rib/pqpg/internal/hpqc/circl/sign/internal/dilithium"
)
